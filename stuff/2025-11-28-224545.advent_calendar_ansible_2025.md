...
本記事は [Ansible Advent Calendar 2025](https://qiita.com/advent-calendar/2025/ansible){:target="_blank"} の1日目の記事です。
...
Emacs は Windows, Mac, Linux などメジャーな環境ではほぼ使えます。どのプラットフォームにインストールしても、初期状態の Emacs で Playbook を書くとこんな感じになります。
